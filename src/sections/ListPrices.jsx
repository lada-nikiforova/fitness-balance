...
const ListPrices = () => {
  ...
  return (
    <section className='flex flex-col items-center mb-5'>
        <h1 className='px-3 text-lg md:text-xl ml-3 text-dark mb-4 text-start lg:text-3xl lg:mb-10 tracking-wider font-druk'>СТОИМОСТЬ АБОНЕМЕНТОВ</h1>
        ...
        <div className="w-full h-90 overflow-x-auto mt-4">
